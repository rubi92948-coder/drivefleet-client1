    ...
    <>
      <section className="max-w-7xl mx-auto px-4 sm:px-6 min-h-[90vh] flex flex-col-reverse md:flex-row items-center justify-between gap-12 pt-24 pb-16 md:py-0 relative">
        ...
        <div className="flex-1 text-center md:text-left z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mb-12">
            <button
              ...
              className="bg-orange-500 hover:bg-orange-600 px-8 py-4 rounded-xl text-md font-bold"
            >
              Explore Cars
            </button>
            ...
            <button
              onClick={() => router.push("/explore-cars")}
              className="border border-neutral-800 px-8 py-4 rounded-xl text-md font-semibold"
            >
              Learn More
            </button>
          </div>
        ...
        <div className="flex-1 flex justify-center items-center relative z-10 w-full">
          <div className="absolute w-[450px] h-[450px] bg-gradient-to-tr from-orange-600/20 to-amber-500/5 blur-[90px] rounded-full" />
          ...
          <Image
            ...
            height={500}
            priority
            className="relative w-full max-w-3xl object-contain transition-transform duration-500 hover:scale-105"
          />
        </div>
      </section>
